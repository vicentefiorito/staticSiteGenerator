...
# function that converts a raw string of Markdown into a list of TextNode objects
def text_to_textnodes(text):
    nodes = [TextNode(text,text_type_text)]
    nodes = split_nodes_delimiter(nodes,"**",text_type_bold) #splits the bold nodes
    nodes = split_nodes_delimiter(nodes,"*",text_type_italic) #splits the italic nodes
    nodes = split_nodes_delimiter(nodes,"`",text_type_code) #splits the code nodes
